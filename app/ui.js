...
const UI = {
    ...
    initSettings() {
        ...
        UI.initSetting('automatic_clipboard', true);
...
* ------v------*/
    ...
    addSettingsHandlers() {
        ...
        UI.addSettingChangeHandler('automatic_clipboard');
        UI.addSettingChangeHandler('automatic_clipboard', UI.updateAutomaticClipboard);
    },
 ...
 * ------v------*/
    ...
    connect(event, password) {
        ...
        UI.rfb.addEventListener("clipboardapifail", UI.handleClipboardAPIFail)
        ...
        UI.rfb.enabledAutomaticClipboard = UI.getSetting('automatic_clipboard');
        if (UI.rfb.enabledAutomaticClipboard) {
            document.getElementById('noVNC_clipboard_button')
                .classList.add('noVNC_hidden');
        }
 ...
 * ------v------*/
    ...
    updateViewOnly() {
        ...
        if (UI.rfb.viewOnly) {
            ...
            document.getElementById('noVNC_toggle_extra_keys_button')
                .classList.remove('noVNC_hidden');
            if (!UI.getSetting('automatic_clipboard')) {
                document.getElementById('noVNC_clipboard_button')
                    .classList.remove('noVNC_hidden');
            }
        }
    ...
    updateAutomaticClipboard() {
        if (!UI.rfb) {
            return;
        }
        UI.rfb.enabledAutomaticClipboard = UI.getSetting('automatic_clipboard');
        if (!UI.rfb.enabledAutomaticClipboard && !UI.getSetting('view_only')) {
            document.getElementById('noVNC_clipboard_button')
                .classList.remove('noVNC_hidden');
        } else {
            document.getElementById('noVNC_clipboard_button')
    ...
    handleClipboardAPIFail() {
        UI.forceSetting('automatic_clipboard', false);
        UI.updateAutomaticClipboard();
    },
